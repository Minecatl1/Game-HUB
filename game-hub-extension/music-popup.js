...
function displayResults(tracks) {
    ...
    tracks.forEach(track => {
        ...
        trackDiv.innerHTML = `
            ...
            <button class="playTrackButton" data-video-id="${track.id.videoId}">Play</button>
        `;
        resultsDiv.appendChild(trackDiv);
    });

    // Add event listeners to play buttons
    document.querySelectorAll('.playTrackButton').forEach(button => {
        button.addEventListener('click', () => {
            playTrack(button.dataset.videoId);
        });
    });
}
...
function displayRecommendations(tracks) {
    ...
    tracks.forEach(track => {
        ...
        trackDiv.innerHTML = `
            ...
            <button class="playTrackButton" data-video-id="${track.id}">Play</button>
        `;
...
// Event listeners
document.getElementById('searchInput').addEventListener('keyup', searchMusic);
...
document.getElementById('pipButton').addEventListener('click', togglePiP);
